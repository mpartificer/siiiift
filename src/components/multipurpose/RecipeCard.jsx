...
function RecipeCard(props) {
    ...
    return (
      <div className='card card-side bg-base-100 shadow-xl w-full standardBorder border-2 border-primary overflow-hidden hover:cursor-pointer' onClick={()=>{toRecipeProfile()}}>
